...
function EvaluacionFinalDetalleContent({ params }: { params: { id: string } }) {
...
export default function EvaluacionFinalDetallePage({ params }: { params: { id: string } }) {
  return (
    <ProtectedRoute requiredRoles={['Taller']}>
      <EvaluacionFinalDetalleContent params={params} />
    </ProtectedRoute>
  );
}