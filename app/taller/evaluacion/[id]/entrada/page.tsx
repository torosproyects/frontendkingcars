...
function EvaluacionEntradaDetalleContent({ params }: { params: { id: string } }) {
  ...
  const handleSave = async (data: CreateEvaluacionEntradaData) => {
    ...
    try {
      ...
      if (success) {
        toast({
          title: "Éxito",
          description: "Evaluación de entrada guardada correctamente",
        });
      ...
      toast({
        title: "Error",
        description: "Error al guardar la evaluación de entrada",
        variant: "destructive",
      });
      return false;
    }
  ...
  return (
    <div className="container mx-auto p-4 space-y-6">
      ...
      {/* Formulario de Evaluación de Entrada */}
      <EvaluacionEntrada
        carro={currentEvaluacion.carro}
        onSave={handleSave}
...
export default function EvaluacionEntradaDetallePage({ params }: { params: { id: string } }) {
  return (
    <ProtectedRoute requiredRoles={['Taller']}>
      <EvaluacionEntradaDetalleContent params={params} />
    </ProtectedRoute>
  );
}