...
export function CreateAuctionForm({ currentUser, onSuccess, onCancel }: CreateAuctionFormProps) {
  ...
  const validateStep2 = () => {
    ...
    if (formData.scheduledStartTime && formData.scheduledStartTime <= new Date()) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await createAuction(formData, currentUser.id, currentUser.name);
      onSuccess?.();
    } catch (err) {
                    ...
                    {!formData.startImmediately && (
                      <div className="relative">
                        ...
                        <Input
                          ...
                          onChange={(e) => setFormData(prev => ({ 
                            ...prev, 
                            scheduledStartTime: e.target.value ? new Date(e.target.value) : undefined 
                          }))}
                          className="pl-10"
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold">
                        {formData.startImmediately ? 'Inmediato' : 'Programado'}
                      </span>
                    </div>
                  </div>
                </div>
